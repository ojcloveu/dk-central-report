        ...
        if (config('backpack.base.setup_auth_routes')) {
            ...
            Route::group(['namespace' => 'Auth'], function () {
                ...
                if (config('backpack.base.setup_password_recovery_routes', true)) {
                    ...
                    Route::post('password/email', 'ForgotPasswordController@sendResetLinkEmail')->name('backpack.auth.password.email')->middleware('backpack.throttle.password.recovery:'.config('backpack.base.password_recovery_throttle_access'));
                }
                ...
                if (config('backpack.base.setup_email_verification_routes', false)) {
                    ...
                    Route::get('email/verify/{id}/{hash}', 'VerifyEmailController@verifyEmail')->name('verification.verify');
